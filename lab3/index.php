...
try {
  ...
  $stmt -> execute(['fio'=>([$_POST['field-name-1']]), 'tel'=>([$_POST['field-tel']]), 'email'=>([$_POST['field-email']]), 'bdate'=>([$_POST['field-date']]), 'gender'=>([$_POST['radio-group1']]), 'biography'=>([$_POST['field-name-2']])]); 
}
